...
from windower.windower import SAMPLES_PER_WINDOW, split_indices
...
# Preprocessing
simplified = data.drop(columns=["weight", "height", "age", "gender", "trial", "gravity.x", "gravity.y", "gravity.z", "act"], errors="ignore")
...
# Get window indices
split_idx = split_indices()  # Assuming this returns [train_indices, test_indices]
